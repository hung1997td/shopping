...
{{--    @include('client.layout.modal')--}}
   @include('client.component.banner')
    ...
    <div class="main_content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single_banner">
                            <img src="{{asset('client/assets')}}/images/shop_banner_img1.jpg" alt="shop_banner_img1"/>
                    ...
                    <div class="col-md-6">
                        <div class="single_banner">
                            <img src="{{asset('client/assets')}}/images/shop_banner_img2.jpg" alt="shop_banner_img2"/>
                            <div class="single_banner_info">
        ...
        <!-- END SECTION BANNER -->
    @include('client.component.shop')
    @include('client.component.single_banner')
        <!-- START SECTION SHOP -->
        <div class="section">
            <div class="container">
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme nav_style1" data-loop="true" data-dots="false" data-nav="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('client/assets')}}/images/product_img1.jpg" alt="product_img1">
                                        </a>
                            ...
                            <div class="item">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('client/assets')}}/images/product_img2.jpg" alt="product_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{asset('client/assets')}}/images/product_img3.jpg" alt="product_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
        ...
        <!-- END SECTION SHOP -->
    @include('client.component.testtimonial')
    @include('client.component.shop_info')
