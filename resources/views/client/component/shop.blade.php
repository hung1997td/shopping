                                    ...
                                    <div class="product">
                                        @foreach($codes as $code)
                                            @if($product->code_id==$code->id)
                                                @if($product->code_id==1)
                                                    <span class="pr_flash">
                                                        {{$code->code}}
                                                    </span>
                                                @endif
                                                @if($product->code_id==2)
                                                    <span class="pr_flash bg-danger">
                                                        {{$code->code}}
                                                    </span>
                                                @endif
                                                @if($product->code_id==3)
                                        ...
                                        <div class="product_img">
                                            <a href="#">
                                                <img src="{{asset('backend/images')}}/{{$product->image}}" alt="product_img3">
                                            </a>
                                            <div class="product_action_box">
                                                <ul class="list_none pr_action_btn">
                                                    <li class="add-to-cart">
                                                        <a href="#"
                                                           data-url="{{route('productAddCart',$product->id)}}"
                                                           class="addCart"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                        ...
                                        <div class="product_info">
                                            <h6 class="product_title"><a href="{{URL::to('product-details',$product->id.$product->slug)}}">{{$product->name}}</a></h6>
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="{{route('productDetail',$product->id)}}">
                                            <img src="{{asset('client/assets')}}/images/product_img9.jpg" alt="product_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                                <li><a href="shop-compare.html" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                                <li><a href="{{route('productDetail',$product->id)}}" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                                <li><a href="#"><i class="icon-heart"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="{{route('productDetail',$product->id)}}">T-Shirt Form Girls</a></h6>
                                        <div class="product_price">
                        ...
                        <div class="row shop_container">
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="{{route('productDetail',$product->id)}}">
                                            <img src="{{asset('client/assets')}}/images/product_img5.jpg" alt="product_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="{{route('productDetail',$product->id)}}">blue dress for woman</a></h6>
                                        <div class="product_price">
                                            <span class="price">$45.00</span>
                                            <del>$55.25</del>
                                            <div class="on_sale">
                        ...
                        <div class="row shop_container">
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="{{route('productDetail',$product->id)}}">
                                            <img src="{{asset('client/assets')}}/images/product_img4.jpg" alt="product_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="{{route('productDetail',$product->id)}}">light blue Shirt</a></h6>
                                        <div class="product_price">
