                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    <div class="product-image">
                        <div class="product_img_box">
                            <img id="product_img" src='{{asset('backend/images').'/'.$product->image}}' data-zoom-image="{{asset('backend/images').'/'.$product->image}}" alt="product_img1" />
                        ...
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                            ...
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image="{{asset('backend/images').'/'.$image->path}}" data-zoom-image="{{asset('backend/images').'/'.$image->path}}">
                                    <img style="height: 100px" src="{{asset('backend/images').'/'.$image->path}}" alt="product_small_img1" />
                                </a>
                            </div>
                                @endif
                            @endforeach
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="pr_detail">
                        <div class="product_description">
                            ...
                            <div class="pr_switch_wrap">
                                ...
                                <div class="product_color_switch">
                                    ...
                                    <span class="active" data-color="{{$color->color_code}}"></span>
                                    @endforeach
                                </div>
                            </div>
                            <div class="pr_switch_wrap">
                        ...
                        <ul class="product-meta">
                            ...
                            <li>Category: <a href="#" class="tags-tranfom">
                            ...
                            <li>Tags:
                                ...
                                <a href="#" rel="tag" class="tags-tranfom">
                                        {{$tag->name.', '}}
                                </a>
                                @endforeach
                            </li>
