                ...
                <div style="width: 40%; margin: auto">
                    ...
                    <form action="{{route('updateUsers', $user->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$user->first_name}}" type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" id="userFirstNameUpdate">
                            @error('first_name')
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$user->last_name}}" type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" id="userLastNameUpdate">
                            @error('last_name')
                            <span style="display: block" class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
