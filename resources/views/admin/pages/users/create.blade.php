                ...
                <div style="width: 40%; margin: auto">
                    <form action="{{route('storeUsers')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('firstname')}}" type="text" name="first_name" class="form-control @error('firstname') is-invalid @enderror" id="userFirstNameAdd">
                            @error('first_name')
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('lastname')}}" type="text" name="last_name" class="form-control @error('lastname') is-invalid @enderror" id="userLastNameAdd">
                            @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
